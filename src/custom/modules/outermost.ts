...
/* Plug-ins */        import { withinInstance } from "../../plugins/figma/component";
...
export const module = new OperationModule("outermost", false, async () => {
  ...
  await library.addNodesFromSelection(false);
    ...
    for (let node of nodes) {
      ...
      if (node.type === "INSTANCE") {
        ...
        if (reference!) {
          ...
          let topLevel = withinInstance(node);
